...
def main():
    ...
    st.write("##### Normalized Difference Vegetation Index changes")
    ...
    with col1:
        ...
        st.markdown("<text style='text-align: center;'>Annual IGBP</text>", unsafe_allow_html=True)

    with col2:
        st.image("/content/lc_type_2.gif")
        st.markdown("<text style='text-align: center;'>Annual UMD</text>", unsafe_allow_html=True)

    with col3:
        st.image("/content/lc_type_3.gif")
        st.markdown("<text style='text-align: center;'>Annual LAI</text>", unsafe_allow_html=True)


    with col4:
        st.image("/content/lc_type_4.gif")
        st.markdown("<text style='text-align: center;'>Annual BGC</text>", unsafe_allow_html=True)
